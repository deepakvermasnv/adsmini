  ...
  return (
    <section className="bg-[#0C0C0B] border-y border-[#252523]">
      <div className="max-w-7xl mx-auto px-6 py-14">
        <p className="text-center text-xs font-bold uppercase tracking-[0.2em] text-[#888880] mb-10">
          Trusted by fast-growing brands across India
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            <div key={i} className="flex flex-col items-center text-center">
              <span className="text-4xl md:text-5xl font-extrabold orange-gradient-text mb-2">
                {s.value}
              </span>
